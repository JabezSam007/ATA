...
<div class="container">
    ...
    <br><br><br>
    <h2 class="heading text-center">VEHICLE BOOKING</h2>
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group text-white">
                    <label for="route">Route</label>
                    <input type="text" class="form-control" id="route" name="route" value="${passenger.booking.vehicle.route}" readonly>
                </div>
            </div>
        <div class="row">
            <div class="col-md-6">
    ...
    <form:form name="form" action="${pageContext.request.contextPath}/payment/pay" method="post" modelAttribute="passenger">
        ...
        <input type="hidden" name="route" value="${passenger.booking.vehicle.route}" readonly>
