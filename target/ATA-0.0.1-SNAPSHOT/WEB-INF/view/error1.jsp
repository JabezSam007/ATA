...
<body onload="document.form.username.focus()">
   <nav class="navbar">
    <a class="navbar-brand" href="/logout">ATA</a>
</nav>
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="error-template">
                ...
                <div class="error-actions">
                    <a href="/passenger/vehicle/all" class="btn btn-primary btn-success"><span class="fa fa-road bg-dark" aria-hidden="true"></span>
                        Return to View Vehicles </a>
                </div>
            </div>
        </div>
    </div>
